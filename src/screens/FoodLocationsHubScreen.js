...
const FoodLocationsHubScreen = ({ route, navigation }) => {
  ...
  const foodLocations = {
    ...
    boysHostels: [
      { id: 'bh1-mess', name: 'BH-1 Mess', location: 'Boys Hostel 1', type: 'Mess', timing: '7:00 AM - 10:00 PM', icon: 'home', color: '#4CAF50' },
      { id: 'bh2-mess', name: 'BH-2 Mess', location: 'Boys Hostel 2', type: 'Mess', timing: '7:00 AM - 10:00 PM', icon: 'home', color: '#2196F3' },
      { id: 'bh3-mess', name: 'BH-3 Mess', location: 'Boys Hostel 3', type: 'Mess', timing: '7:00 AM - 10:00 PM', icon: 'home', color: '#FF9800' },
      { id: 'bh4-mess', name: 'BH-4 Mess', location: 'Boys Hostel 4', type: 'Mess', timing: '7:00 AM - 10:00 PM', icon: 'home', color: '#9C27B0' },
      { id: 'bh5-mess', name: 'BH-5 Mess', location: 'Boys Hostel 5', type: 'Mess', timing: '7:00 AM - 10:00 PM', icon: 'home', color: '#607D8B' },
      { id: 'bh6-mess', name: 'BH-6 Mess', location: 'Boys Hostel 6', type: 'Mess', timing: '7:00 AM - 10:00 PM', icon: 'home', color: '#795548' },
      { id: 'bh7-mess', name: 'BH-7 Mess', location: 'Boys Hostel 7', type: 'Mess', timing: '7:00 AM - 10:00 PM', icon: 'home', color: '#FF5722' },
      { id: 'bh8-mess', name: 'BH-8 Mess', location: 'Boys Hostel 8', type: 'Mess', timing: '7:00 AM - 10:00 PM', icon: 'home', color: '#009688' },
    ],
    girlsHostels: [
